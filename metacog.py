...
from basecode2.app_management import (
    load_app_settings,
...
from basecode2.personal_prompt import (
    set_prompt_settings,
...
from cotf_functions.metacog_feedback import metacog_feedback
from cotf_functions.metacog_tf import tf_chatbot_functions
...
def main():
    try:
        ...
        sac.divider(
            label="ETD & ITD Prototyping Framework", icon="house", align="center"
        )
                    ...
                    [
                            ...
                            children=[
                                ...
                                sac.MenuItem(
                                    return_function_name(
                                        "Thinking Facilitator", "Thinking Facilitator"
                                    ),
                                    icon="person-circle",
                                    disabled=is_function_disabled(
                        ...
                        sac.MenuItem(
                            ...
                            children=[
                                ...
                                sac.MenuItem(
                                    return_function_name("Prompt Management"),
                                    icon="wrench",
        ...
        # Personal Dashboard
            ...
            st.subheader(f":green[{st.session_state.option}]")
            metacog_feedback()
        elif st.session_state.option == "Thinking Facilitator":
            st.subheader(f":green[{st.session_state.option}]")
            tf_chatbot_functions()
        ...
        # Organisation Tools
            ...
            if (
                ...
                if steps_options == "Create new school":
                    ...
                    action = st.selectbox(
                        "Select action",
                        ["Select", "Manage Teachers", "Manage Students"],
                    )
