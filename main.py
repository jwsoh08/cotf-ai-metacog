...
def main():
	try:
		...
		sac.divider(label='ETD & ITD Prototyping Framework', icon='house', align='center')
		...
		with st.sidebar: #options for sidebar
			if st.session_state.login == False:
				...
				st.session_state.option = sac.menu([
					...
					sac.MenuItem('AIED', icon='chat-dots', children=[
						sac.MenuItem(return_function_name('Short Answer FA Analyser'), icon='person-circle', disabled=is_function_disabled('Short Answer FA Analyser')),
						sac.MenuItem(return_function_name('AC Co-Pilot', "Authoring Co-Pilot"), icon='person-circle', disabled=is_function_disabled('AC Co-Pilot')),
					]),
		...
		elif st.session_state.option == 'Authoring Co-Pilot':
			st.subheader(f":green[{st.session_state.option}]")
			ac_co_pilot()
		elif st.session_state.option == 'Short Answer FA Analyser':
			st.subheader(f":green[{st.session_state.option}]")
			prompt_analyser()
